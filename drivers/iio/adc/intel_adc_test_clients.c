 ...
 */
static int intel_adc_test_probe(struct platform_device *p_platform_dev)
 ...
 */
static int intel_adc_test_remove(struct platform_device *p_platform_dev)
{
	/* Nothing to do */
	return 0;
}
 ...
 */
static int intel_adc_test_client_init(void)
{
 ...
 */
static void intel_adc_test_client_exit(void)
{
