...
static int __exit xgold_capcom_remove(struct platform_device *pdev)
{
...
static struct platform_driver xgold_capcom_driver __refdata = {
	.probe = xgold_capcom_probe,
	.remove = __exit_p(xgold_capcom_remove),
#ifdef CONFIG_PM
