 ...
 */
static void xgold_irq_wake_display_table(struct xgold_irq_wake_table *t,
		char *name)
{
	int32_t i = 0;
 ...
 */
static int32_t xgold_irq_wake_fill_table(struct device_node *np,
...
static int32_t xgold_irq_wake_init(void)
{
