 ...
 * @p_platform_dev	[in]	Pointer to platform device which triggered
				the probe.
 */
static int pmic_swfg_hal_probe(struct platform_device
							*p_platform_dev)
{
	int ret = 0;
	u32 reg;
 ...
 */
static int pmic_swfg_hal_remove(struct platform_device
							*p_platform_dev)
{
 ...
 */
static int pmic_swfg_hal_init(void)
{
 ...
 */
static void pmic_swfg_hal_exit(void)
{
