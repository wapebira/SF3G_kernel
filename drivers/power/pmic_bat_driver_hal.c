 ...
 */
static int bat_drv_probe(struct platform_device *p_platform_dev)
{
	int ret = 0;
 ...
 */
static int bat_drv_remove(struct platform_device *p_platform_dev)
{
	struct bat_drv_data *pbat = &bat_drv_instance;
