 ...
 */
static int bat_drv_hal_probe(struct platform_device *p_platform_dev)
{
 ...
 */
static int bat_drv_hal_remove(struct platform_device *p_platform_dev)
{
...
static int bat_drv_hal_init(void)
{
	return platform_driver_register(&bat_hal_driver);
}

static void bat_drv_hal_exit(void)
{
