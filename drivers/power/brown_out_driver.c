...
#define BUV_DET_LEVEL_2500MV	(0x0)
 ...
 */
static int brown_out_drv_probe(struct idi_peripheral_device *ididev,
						const struct idi_device_id *id)
{
	...
	bat_uv_det |= (BUV_DET_LEVEL_2500MV << BAT_UV_DET_BULVL_O);
 ...
 */
static int brown_out_drv_remove(struct idi_peripheral_device *ididev)
{
...
static int brown_out_drv_init(void)
{
	int ret;
...
static void brown_out_drv_exit(void)
{
