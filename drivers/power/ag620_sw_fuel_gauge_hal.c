 ...
 */
static int sw_fuel_gauge_hal_probe(struct idi_peripheral_device *ididev,
 ...
 */
static int sw_fuel_gauge_hal_remove(struct idi_peripheral_device *ididev)
{
 ...
 */
static int sw_fuel_gauge_hal_init(void)
{
	int ret;
 ...
 */
static void sw_fuel_gauge_hal_exit(void)
{
