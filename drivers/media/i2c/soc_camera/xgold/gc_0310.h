...
#define GC0310_FOCAL_VALUE \
		((GC0310_FOCAL_LENGTH_NUM << 16) | GC0310_FOCAL_LENGTH_DEM)

#define GC0310_FNUMBER_VALUE \
		((GC0310_F_NUMBER_DEFAULT_NUM << 16) | GC0310_F_NUMBER_DEM)
...
/* 640x360 settings */
static struct gc_register const gc0310_640x360[] = {
   {GC_8BIT, 0xfe, 0x00},
   {GC_8BIT, 0x0a, 0x00},
   {GC_8BIT, 0x0c, 0x04},
   {GC_8BIT, 0x0d, 0x01},
...
*/
	...
	{ GC_8BIT, 0xd0, 0x40 },
	{ GC_8BIT, 0xd1, 0x32 },  // 34
	{ GC_8BIT, 0xd2, 0x32},  //34
	{ GC_8BIT, 0xd3, 0x3d },  //40
	{ GC_8BIT, 0xd6, 0xf2 },
	{ GC_8BIT, 0xd7, 0x1b },
	{ GC_8BIT, 0xd8, 0x18 },
	{ GC_8BIT, 0xdd, 0x03 },
...
static struct gc_register gc0310_night_mode_on_table[] = {
	{GC_8BIT, 0xfe, 0x01},
	{GC_8BIT, GC0310_REG_MAX_AEC, 0x20},
	{GC_TOK_TERM, 0, 0},
};
...
struct gc_product_info gc0310_product_info = {
	...
	*/
	...
	.settings_tables = {
		GC_ADD_SETTINGS_TABLES(GC_SETTING_STREAM,
			gc0310_stream_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_EXPOSURE,
			gc0310_exposure_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_VFLIP,
			gc0310_vflip_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_HFLIP,
			gc0310_hflip_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_SCENE_MODE,
			gc0310_scene_mode_tables),
		GC_ADD_SETTINGS_TABLES(GC_SETTING_COLOR_EFFECT,
