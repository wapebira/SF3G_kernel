...
static int xgold_platform_rtc_probe(struct platform_device *pdev)
{
...
static int xgold_platform_rtc_remove(struct platform_device *pdev)
{
	struct rtc_driver_data *rtcd = platform_get_drvdata(pdev);
...
static struct platform_driver xgold_platform_rtc_driver = {
	...
	.remove = xgold_platform_rtc_remove,
...
static int xgold_platform_rtc_init(void)
{
	return platform_driver_register(&xgold_platform_rtc_driver);
}

static void xgold_platform_rtc_exit(void)
{
