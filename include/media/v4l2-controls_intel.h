...
#define INTEL_VIDIOC_ZOOM_W_H _IOWR('v', BASE_VIDIOC_PRIVATE + 1, struct xgold_zoom_buff)
#define INTEL_VIDIOC_OTF_ZSL_MODE _IOWR('v', BASE_VIDIOC_PRIVATE + 2, int)
