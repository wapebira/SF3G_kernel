...
/* rockchip_iovmm_map_oto
 * create one to one mapping for the given physical address
 ...
 */
int rockchip_iovmm_unmap_oto(struct device *dev, phys_addr_t phys);
...
static inline void rockchip_iovmm_unmap_oto(struct device *dev,
						phys_addr_t phys)
{
}
