...
enum sensor_id {
	...
	PROXIMITY_ID_TMD2772,
	PROXIMITY_ID_CM36682,
	PROXIMITY_ID_RPR0521,
...
extern int sensor_rx_data(struct i2c_client *client, unsigned  char *rxData, int length);
...
extern int sensor_read_word_reg(struct i2c_client *client, uint8_t addr);
extern int sensor_write_word_reg(struct i2c_client *client, int addr, int value);
