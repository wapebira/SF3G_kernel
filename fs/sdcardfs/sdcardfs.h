...
out_invalid:
	pr_debug("statfs               : invalid return\n");
	pr_debug("vfs_statfs error#    : %d\n", err);
	pr_debug("statfs.f_type        : 0x%X\n", (u32)statfs.f_type);
	pr_debug("statfs.f_blocks      : %llu blocks\n", statfs.f_blocks);
	pr_debug("statfs.f_bfree       : %llu blocks\n", statfs.f_bfree);
	pr_debug("statfs.f_files       : %llu\n", statfs.f_files);
	pr_debug("statfs.f_ffree       : %llu\n", statfs.f_ffree);
	pr_debug("statfs.f_fsid.val[1] : 0x%X\n", (u32)statfs.f_fsid.val[1]);
	pr_debug("statfs.f_fsid.val[0] : 0x%X\n", (u32)statfs.f_fsid.val[0]);
	pr_debug("statfs.f_namelen     : %ld\n", statfs.f_namelen);
	pr_debug("statfs.f_frsize      : %ld\n", statfs.f_frsize);
	pr_debug("statfs.f_flags       : %ld\n", statfs.f_flags);
	pr_debug("sdcardfs reserved_mb : %u\n", sbi->options.reserved_mb);
	if (sbi->devpath)
		pr_debug("sdcardfs source path : %s\n", sbi->devpath);

out_nospc:
	printk_ratelimited(KERN_INFO
			   "statfs.f_bavail : %llu blocks / "
