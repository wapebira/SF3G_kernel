				  ...
				  unsigned long nr_segs)
{
	 ...
	 * __dentry_open checks a_ops->direct_IO and returns EINVAL if it is
	 * null.
	...
	pr_debug("%s, operation is not supported\n", __func__);

	return 0;
}

/* Shawn Lin:
 * .page_mkwrite use for setting page dirty from v3.12
 */
