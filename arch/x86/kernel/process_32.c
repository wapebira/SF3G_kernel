...
static void show_extra_register_data(struct pt_regs *regs, int nbytes)
{
	...
	show_data(regs->ds - nbytes, nbytes * 2, "DS");
	show_data(regs->es - nbytes, nbytes * 2, "ES");
	show_data(regs->fs - nbytes, nbytes * 2, "FS");
	show_data(gs - nbytes, nbytes * 2, "GS");
	show_data(ss - nbytes, nbytes * 2, "SS");
	set_fs(fs);
}
