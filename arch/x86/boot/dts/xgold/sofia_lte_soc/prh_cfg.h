...
/**< Enable MMC_CORE_CLK high performance use cases */
#define PRH_PER_MMC_CORE_CLK_ENABLE_UHIGH_PERF (PRH_PER_MMC_CORE_CLK_ENABLE_HIGH_PERF + 1)
/**< End indicator (reserved for PRH driver) */
#define PRH_PER_MMC_CORE_CLK_MODE_END (PRH_PER_MMC_CORE_CLK_ENABLE_UHIGH_PERF + 1)
