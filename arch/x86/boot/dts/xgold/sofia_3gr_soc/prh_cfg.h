...
/**< Start indicator (reserved for PRH driver) */
#define PRH_PER_EXT_HDMI_MODE_START (PRH_PER_RGA_MODE_END + 1)
/**< Disable HDMI clock */
#define PRH_PER_EXT_HDMI_DISABLE (PRH_PER_EXT_HDMI_MODE_START + 1)
/**< Enable HDMI Low clock  */
#define PRH_PER_EXT_HDMI_ENABLE (PRH_PER_EXT_HDMI_DISABLE + 1)
/**< Enable HDMI Medium clock  */
#define PRH_PER_EXT_HDMI_ENABLE_PSV (PRH_PER_EXT_HDMI_ENABLE + 1)
/**< End indicator (reserved for PRH driver) */
#define PRH_PER_EXT_HDMI_MODE_END (PRH_PER_EXT_HDMI_ENABLE_PSV + 1)
...
#define PRH_USER_EXT_HDMI (PRH_USER_PWM + 1)
#define PRH_USER_OTG (PRH_USER_EXT_HDMI + 1)
#define PRH_USER_SPEC_POW (PRH_USER_OTG + 1)
/**< PRH user dummy identifier */
#define PRH_USER_DUMMY (PRH_USER_SPEC_POW + 1)
#else
/**< PRH user dummy identifier */
...
/**< PRH peripheral identifier for PMU  from hdmi */
#define PRH_PER_EXT_HDMI (PRH_PER_PWM + 1)
/**< PRH peripheral identifier for otg */
#define PRH_PER_EXT_OTG (PRH_PER_EXT_HDMI + 1)
/**< PRH peripheral identifier for public */
#define PRH_PER_EXT_SPEC_POW (PRH_PER_EXT_OTG + 1)
/**< PRH peripheral dummy identifier  */
#define PRH_PER_DUMMY (PRH_PER_EXT_SPEC_POW + 1)
#else
/**< PRH peripheral dummy identifier  */
...
/**< PRH peripheral identifier for PWM peripheral */
#define PRH_PER_TYPE_EXT_HDMI (PRH_PER_TYPE_PWM + 1)
/**< End indicator (reserved for PRH driver) */
#define PRH_PER_NOF_TYPE (PRH_PER_TYPE_EXT_HDMI + 1)
#else
/**< End indicator (reserved for PRH driver) */
